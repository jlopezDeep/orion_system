...
function getslcategory(carid, category_name, color = null) {
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data == '420') {
                $("#product_search").html('NO HAY PRODUCTOS');
            } else {
                $("#product_search").html(data);
            }
            //var table_final = localStorage.getItem('table_transfer_id');
            document.getElementById("category_active").innerHTML = category_name;
            if (color != null && color != "" && color != undefined) {
                document.getElementById("category_active").style.backgroundColor = color;
                document.getElementById("category_active").style.color = "white";
            } else {
                document.getElementById("category_active").style.backgroundColor = "white";
                document.getElementById("category_active").style.color = "#374767";
            }
        },
        error: function() {
...
function placeorder() {
    ...
    if (ctypeid == 3) {
        ...
        if (possetting.tableid == 1) {
            if (tableid == '') {
                $("#tableid").select2('open');
                toastr.warning("Elija una mesa", 'Warning');
                return false;
            }
            if (possetting.tablemaping == 1) {

                if (tableid == '' || !$.isNumeric($('#table_person').val())) {
                    toastr.warning("Este tipo de orden neceita una mesa", 'Warning');
                    return false;
                }
            }
        }
...
function editposorder(id, view, user_view = 0) {
    //alert(user_view);
    if (user_view == 0) {
        ...
        swal({
                title: "MESA TOMADA POR OTRO USUARIO",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
...
function table_transfer(order_id, tableidfinal, tableOrigin = 0) {
    //===================================================================
    var password = null;
    swal({
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (password == data) {
                        ...
                        //===================================================================
                        var table_final = localStorage.getItem('table_transfer_id');
                        if (table_final != undefined && table_final != null && table_final != "") {
                            var url = 'table_transfer' + '/' + order_id + "/" + table_final + "/" + tableOrigin;
                            var csrf = $('#csrfhashresarvation').val();
                            $.ajax({
                                type: "GET",
                                url: url,
                                ...
                                success: function(data) {
                                    ...
                                    //giveselecttab(this);
                                    document.getElementById("ongoingorder").click();
                                    localStorage.removeItem('table_transfer_id');
                                    swal({
                                            title: "Orden " + order_id + " transferida correctamente!!!",
                                            text: "",
                                            type: "success",
                                            showCancelButton: true,
                                            confirmButtonColor: "#DD6B55",
                            ...
                            swal({
                                    title: "DEBE ELEJIR UNA MESA A LA QUE PASAR LA ORDEN",
                                    text: "",
                                    type: "error",
                                    showCancelButton: true,
                                    confirmButtonColor: "#DD6B55",
...
function mark_order(order_id, value) {
    //===================================================================
    var password = null;
    swal({
            title: "INGRESE LA CLAVE DE GERENTE",
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (password == data) {
                        ...
                        var url = 'markOrder' + '/' + order_id + '/' + value;
                        var csrf = $('#csrfhashresarvation').val();
                        $.ajax({
                            type: "GET",
                            url: url,
...
function products_transfer(order_id) {
    //===================================================================
    var password = null;
    swal({
            title: "INGRESE LA CLAVE DE GERENTE",
        ...
        function(inputValue) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (password == data) {
                        var order_final = localStorage.getItem('order_transfer_id');
                        if (order_final != undefined && order_final != null && order_final != "") {
                            var url = 'products_transfer' + '/' + order_id + "/" + order_final;
                            var csrf = $('#csrfhashresarvation').val();
                            $.ajax({
                                type: "GET",
                                url: url,
                                ...
                                success: function(data) {
                                    ...
                                    //giveselecttab(this);
                                    document.getElementById("ongoingorder").click();
                                    localStorage.removeItem('order_transfer_id');
                                    swal({
                                            title: "Productos pasados de la orden " + order_id + " a la orden: " + order_final + " correctamente!!!",
                                            text: "",
                                            type: "success",
                                            showCancelButton: true,
                                            confirmButtonColor: "#DD6B55",
                                        ...
                                        function() {
                                            //editposorder(order_id, 1);
                                            var ordid = order_id; //$("#mycanorder").val();
                                            var reason = "TRANSFERIDA A " + order_final; //$("#canreason").val();
                                            var csrf = $('#csrfhashresarvation').val();
...
function quickorder() {
    ...
    if (isitem == '' || isitem == 0) {
        ...
        //alert("Please add Some Food!!!");
        swal({
                title: "Por favor agregue algun producto al pedido",
                text: "",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55",
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (err == "error") {
                    ...
                    swal({
                            title: "Facturar directamente?", //lang.ord_places,
                            text: "Desea facturar directamente esta orden",
                            type: "success",
                            showCancelButton: true,
                            confirmButtonColor: "#28a745",
...
function postupdateorder_ajax(redirect = 0) {
...
$(document).on('click', '#add_new_payment_type', function() {
    ...
    if (total == gtotal) {
        ...
        swal({
                title: "EL MONTO DEL PAGO EXCEDE EL TOTAL DE LA ORDEN",
                text: "",
                type: "warning",
                showCancelButton: false,
                confirmButtonColor: "#28a745",
...
function submitmultiplepay(type) {
    ...
    if (inputval < parseFloat(maintotalamount)) {
        ...
        setTimeout(function() {
            ...
            toastr.error("Pague todo el monto antes de cerrar", 'Error');
        }, 100);
        return false;
    }
    var formdata = new FormData(thisForm[0]);
    if (parseFloat(maintotalamount) > 0) {
        $.ajax({
            type: "POST",
            url: basicinfo.baseurl + "ordermanage/order/paymultiple/" + type,
            data: formdata,
            processData: false,
            contentType: false,
            success: function(data) {
                ...
                if (value == 1) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: basicinfo.baseurl + "ordermanage/order/validateParam/" + 5,
                        //data: formdata,
                        processData: false,
                        contentType: false,
                        success: function(data) {
                            if (data == 0) {
                                if (type == 0 && parseFloat(maintotalamount) > 0) {
                                    window.location.href = basicinfo.baseurl + "descarga.php";
                                }
                            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (password == data) {
                        var csrf = $('#csrfhashresarvation').val();
                        $.ajax({
                            url: basicinfo.baseurl + "ordermanage/order/freeTables",
                            method: "GET",
                            //data: dataString,
                            success: function(data) {
                                console.log("Listo");
...
function checktabletransfer(idtable) {
    localStorage.setItem('table_transfer_id', idtable);
    swal({
...
function checkordertransfer(order) {
    localStorage.setItem('order_transfer_id', order);
    swal({
...
function checktable(id = null, user_view = 0) {
    ...
    if (user_view == 0) {
        ...
        if (id != null) {
            ...
            //localStorage.setItem('table_transfer_id', id);
        } else {
            idd = $('#tableid').val();
            var url = 'checktablecap/' + idd;
            //localStorage.setItem('table_transfer_id', idd);
        }
        var order_person = $('#table_member').val();


        if (order_person != "" && order_person != "0") {
            var csrf = $('#csrfhashresarvation').val();
            $.ajax({
                type: "GET",
                url: url,
            ...
            setTimeout(function() {
                ...
                toastr.error('Ingrese el numero de personas', 'Error');
        ...
        toastr.error('Mesa tomada por otro usuario', 'Error');
    }
    //localStorage.setItem('table_transfer_id', id);
}
...
function validateUpdateOrder() {
    console.log('Buscando cambios ongoingorder');
    if (localStorage.getItem('update_view') == '1') {
        //===================================================================
        var url = 'validateUpdateOrder';
        var csrf = $('#csrfhashresarvation').val();
        $.ajax({
            type: "GET",
            url: url,
            ...
            success: function(data) {
                if (data == 0) {
                    $('#ongoingorder').click();
                    console.log('Cambios cargados en ongoingorder');
                }
            }
        });
    }
...
function closeopenresister() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            var puser = $("#puser").val();
            var fullheader = "CIERRE DE TURNO CAJERO" + htitle + "\n" + "CAJA:" + counter + "\n" + puser;
...
function printmanagementreport() {
    $.ajax({
        type: "GET",
        url: basicinfo.baseurl + "ordermanage/order/printReportManagement",
        //data: formdata,
        processData: false,
        contentType: false,
        success: function(data) {
            //=============================
            swal({
                    title: "EL REPORTE GERENCIAL FUE IMPRESO",
                    text: "",
                    type: "success",
                    showCancelButton: false,
                    confirmButtonColor: "#28a745",
...
function filterOrdersType(value) {
    $.ajax({
        type: "GET",
        url: basicinfo.baseurl + "ordermanage/order/filterOrdersType/" + value,
        //data: formdata,
        processData: false,
        contentType: false,
        success: function(data) {
...
function filterOrdersSearch(value) {
    $.ajax({
        type: "GET",
        url: basicinfo.baseurl + "ordermanage/order/filterOrdersSearch/" + value,
        //data: formdata,
        processData: false,
        contentType: false,
        success: function(data) {
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data == 1) {
                ...
                //=============================
                swal({
                        title: "EL REPORTE X FUE IMPRESO",
                        text: "",
                        type: "success",
                        showCancelButton: false,
                        confirmButtonColor: "#28a745",
                    ...
                    function() {
                        window.location.href = basicinfo.baseurl + "logout";
                    });
                window.location.href = basicinfo.baseurl + "descarga.php";
            } else {
                swal({
                        title: "EL REPORTE X DIO UN ERROR",
                        text: "",
                        type: "error",
                        showCancelButton: false,
                        confirmButtonColor: "#28a745",
...
function closecashregisterz() {
    //window.location.href = basicinfo.baseurl + "dashboard/home";
    swal({
            title: "DESEA IMPRIMIR EL REPORTE Z AHORA?",
            text: "Al imprimir este reporte estara cerrando el dia fiscal.",
            type: "success",
            showCancelButton: true,
            confirmButtonColor: "#28a745",
        ...
        function(isConfirm) {
            ...
            if (isConfirm) {
                $.ajax({
                    type: "GET",
                    url: basicinfo.baseurl + "ordermanage/order/closecashregisterz_prev",
                    //data: formdata,
                    processData: false,
                    contentType: false,
                    success: function(data) {
                        ...
                        if (data == 1) {
                            ...
                            //=============================
                            swal({
                                    title: "EL REPORTE Z SERA IMPRESO",
                                    text: "",
                                    type: "success",
                                    showCancelButton: false,
                                    confirmButtonColor: "#28a745",
                                ...
                                function() {
                                    $.ajax({
                                        type: "GET",
                                        url: basicinfo.baseurl + "ordermanage/order/closecashregisterz",
                                        //data: formdata,
                                        processData: false,
                                        contentType: false,
                                        success: function(data) {
                                            if (data == 1) {
                                                ...
                                                //=============================
                                                swal({
                                                        title: "EL REPORTE Z FUE IMPRESO",
                                                        text: "",
                                                        type: "success",
                                                        showCancelButton: false,
                                                        confirmButtonColor: "#28a745",
                                                ...
                                                swal({
                                                        title: "EL REPORTE Z DIO UN ERROR",
                                                        text: "",
                                                        type: "error",
                                                        showCancelButton: false,
                                                        confirmButtonColor: "#28a745",
