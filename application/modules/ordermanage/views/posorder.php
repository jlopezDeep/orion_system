...
<div class="modal fade modal-warning" id="client-info" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group row">
          <label for="name" class="col-sm-3 col-form-label"><?php echo "ID Numero:" ?> <i class="text-danger">*</i></label>
          <div class="col-sm-6">
            <input class="form-control simple-control" name="customer_no" id="no" type="text" placeholder="<?php echo "ID"; ?>" required="">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-6">
            <textarea class="form-control" name="address" id="address " rows="3" placeholder="<?php echo display('b_address'); ?>"></textarea>
          </div>
        </div>
        <div class="form-group row">
    ...
    <div class="panel-body">
      <div class="tabsection"> <span class="display-none"><?php echo $settinginfo->language; ?></span>
        <ul class="nav nav-tabs mb-2" role="tablist">
          ...
          <li><a href="<?php echo base_url() ?>logout" class="maindashboard" style="background-color:red;"><i class="fa fa-close"></i></a></li>
          <li><a href="<?php echo base_url() ?>dashboard/home" class="maindashboard"><i class="fa fa-home"></i></a></li>

          <li> <a href="#" role="tab" data-toggle="tab" title="" class="ongord newtab" onclick="showTablemodal()"><i class="fa fa-plus smallview"></i> <span class="responsiveview">MESAS</span> </a></li>
          <li class="active"> <a href="#home" id="onhomeorder" role="tab" data-toggle="tab" title="New Order" class="home newtab" onclick="giveselecttab(this)"><i class="fa fa-plus smallview"></i> <span class="responsiveview"><?php echo display('nw_order'); ?></span> </a></li>
          ...
          <?php if ($station_info->is_billing_station == 1) { ?>
            <li class="mobiletag"><a class="btn btn-primary ml-l" style="background-color: red;color:white;list-style-type: none;" onclick="closecashregisterz()" role="button">Z</a></li>
            <li class="mobiletag"><a href="javascript:;" style="background-color: blue;color:white;list-style-type: none;" class="btn btn-primary ml-l" onclick="closeopenresister()" role="button">X</a></li>
          <?php } ?>
          <li class="mobiletag">
            <!--<a href="#"><i class="fa fa-keyboard hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="<table class='table table-condensed table-striped' >
        <tr>
            <th>Operations</th>
        ...
        <div class="tgbar">
          <ul style="list-style-type:none;">
            <?php if ($station_info->is_billing_station == 1) { ?>
              <li class="mobiletag" style="float: left;"><a href="javascript:;" class="btn btn-primary ml-l" style="background-color: orange;color:white;list-style-type: none;height:35px;width: 100px;font-size: 21px;padding-top:2px;" onclick="add_tips()" role="button">PROPI.</a></li>
              <li class="mobiletag" style="float: left;"><a href="javascript:;" class="btn btn-primary ml-l" style="background-color: brown;color:white;list-style-type: none;height:35px;width: 100px;font-size: 21px;padding-top:2px;" onclick="cash_expenses()" role="button">RETIRO</a></li>
              <li class="mobiletag" style="float: left;"><a href="javascript:;" class="btn btn-primary ml-l" style="background-color: green;color:white;list-style-type: none;height:35px;width: 35px;font-size: 21px;padding-top:2px;" onclick="printmanagementreport()" role="button">G</a></li>
              <li class="mobiletag" style="float: left;"><a href="javascript:;" class="btn btn-primary ml-l" style="background-color: red;color:white;list-style-type: none;height:35px;width: 35px;font-size: 21px;padding-top:2px;" onclick="closecashregisterz()" role="button">Z</a></li>
              <li class="mobiletag" style="float: left;"><a href="javascript:;" style="background-color: blue;color:white;list-style-type: none;height:35px;width: 35px;font-size: 21px;padding-top:2px;" class="btn btn-primary ml-l" onclick="closeopenresister()" role="button">X</a></li>
            <?php } ?>
          </ul>
          <?php if ($new_version > $myversion) {
            if ($versioncheck->version != $new_version) {
          ...
          <a id="fullscreen" href="#" style="margin-top:-10px;"><i class="pe-7s-expand1"></i></a>
          <!--<a href="#"><i class="fa fa-keyboard hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="<table class='table table-condensed table-striped' >
        <tr>
            <th>Operations</th>
            <th>Keyboard Shortcut</th>
      ...
      <div class="tab-content tab-content-xs">
                    ...
                    <div class="row">
                      <div class="col-md-2">
                        <div class="product-category">
                          <div class="listcat" onclick="getslcategory('','TODOS', '')"><?php echo display('all') ?> </div>
                          ...
                          ?>
                              <div class="listcat dropdown cat-nav">
                                ...
                                <ul class="dropdown-menu dropcat">
                                  <?php foreach ($category->sub as $subcat) { ?>
                                    <li><a onclick="getslcategory(<?php echo $subcat->CategoryID; ?>,'<?php echo $subcat->Name; ?>', '<?php echo $category->color; ?>')"><?php echo $subcat->Name; ?></a></li>
                                  <?php } ?>
                                </ul>
                            ...
                            <?php } else { ?>
                              ...
                              <div class="listcat dropdown cat-nav" style="background-color: <?php echo $category->color; ?>" onclick="getslcategory(<?php echo $category->CategoryID; ?>,'<?php echo $category->Name; ?>', '<?php echo $category->color; ?>')"><?php echo $category->Name; ?></div>
                          <?php  }
                          } ?>
                      ...
                      <script>
                        ...
                        function move_up() {
                          ...
                          document.getElementById('product-grid').scrollTop += 40;
                      ...
                      <div class="col-md-10">
                        <div style="padding:10px;font-weight: bold;float:initial;" id="category_active">
                          TODOS
                        </div>


                        <div style="height:100%">
                          <div class="product-grid stop-scrolling" id="product-grid" style="background:#f8edc9;padding:10px;">
                        ...
                        <div style="margin-top:5px;">
                          ...
                          <button onclick="move_up();" style="padding:10px;font-weight: bold;float:right;margin-right: 5px;" class="btn dropdown-toggle listcat listcat2" type="button" data-toggle="dropdown">
                            ABAJO
                          </button>

                          <button onclick="move_down();" style="padding:10px;font-weight: bold;float:right;margin-right: 5px;" class="btn dropdown-toggle listcat listcat2" type="button" data-toggle="dropdown">
                            ARRIBA
                          </button>
                        </div>
                      </div>
                    ...
                    <form action="<?php echo base_url("ordermanage/order/pos_order") ?>" class="form-vertical" id="onlineordersubmit" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                      <div class="row">
                        <div class="col-md-6 form-group">
                          ...
                          <div class="d-flex">
                            <?php $cusid = 1;
                            echo form_dropdown('cuntomer_no', $customerlist, (!empty($cusid) ? $cusid : null), 'class="postform resizeselect form-control" id="customer_name" required') ?>
                          ...
                          <div class="row">
                            ...
                            ?>
                              <div class="col-md-2 form-group pl-0" id="tblsecp">
                                ...
                                <input name="" style="width:100%;" type="button" class="btn btn-primary  form-control width-auto" onclick="showTablemodal()" id="table_person" value="<?php echo display('person'); ?>">
                                <input type="hidden" id="table_member" name="table_member" class="form-control" value="" />
                              </div>
                            <?php } ?>
                            <div class="col-md-12 form-group">
                              <input name="comentario" type="text" class="form-control" id="comentario" placeholder="COMENTARIO" />
                            </div>
                            <!--
                      ...
                      <div class="productlist" id="productlist">
                        <div class="product-list pdlist" id="product-list">
                                  ...
                                  ?>
                                    <tr id="<?php echo $i; ?>" style="background-color:<?php echo $color; ?>;">
                                      ...
                                      <td scope="row">
                                        ...
                                        onclick="posupdatecart('<?php echo $item['rowid'] ?>',<?php echo $item['pid']; ?>,
                                        <?php echo $item['sizeid'] ?>,<?php echo $item['qty']; ?>,'add')">
                                        <i class="fa fa-plus" aria-hidden="true"></i></a> -->
                                          <span id="productionsetting-<?php echo $item['pid'] . '-'
                                                                        . $item['sizeid'] ?>" style="font-size:18px;">
                                            <?php echo $item['qty']; ?>
                                          </span>
                                        </div>
                      ...
                      <div class="fixedclasspos">
                        <div class="row d-flex flex-wrap align-items-center">
                                ...
                                <td>
                                  <div class="row m-0">
                                    ...
                                    <strong>
                                      ...
                                      <span id="calvat"> <?php echo round($calvat, 2); ?></span>
                                      <?php if ($currency->position == 2) {
                                        echo $currency->curr_icon;
                                      } ?>
                                    </strong>
                                ...
                                <td rowspan="2"><label for="date" class="mb-0 col-sm-6"><?php echo display('grand_total') ?>:</label>
                                  <label class="col-sm-6 p-0 mb-0">
                                    ...
                                    <span class="badge badge-primary grandbg font-26"><strong>
                                        ...
                                        <span id="caltotal"><?php echo round($calvat + $itemtotal + $servicetotal - ($discount + $pdiscount), 2); ?></span>
                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  <div class="col-sm-3 p-0">
                                    <input type="text" id="service_charge" onchange="calculatetotal();" class="form-control text-right mb-5" value="<?php echo $servicecharge; ?>" name="service_charge" placeholder="0.00" />
                                  </div>
                                  <div class="col-sm-3 p-0">

                                    <a style="margin-top:10px;font-weight: bold;cursor:pointer;color:red;" onclick="removeServiceUpdate();">ELIMINAR</a>
                                  </div>
                              ...
                              <tr>
                                <td>
                                  ...
                                  <div class="col-sm-4 p-0">
                                    <input id="caltotal_tasa" type="text" disabled="true" class="form-control text-right mb-5" value="<?php echo $currency_rate->curr_rate; ?>" placeholder="0.00" />
                                  </div>
                                ...
                                <td>
                                  ...
                                  <div class="col-sm-4 p-0">
                                    <span class="badge badge-primary grandbg font-26" id="caltotal_total"><?php if (($calvat + $itemtotal + $servicetotal - ($discount + $pdiscount)) != "") {
                                                                                                            echo round($currency_rate->curr_rate * ($calvat + $itemtotal + $servicetotal - ($discount + $pdiscount)), 2);
                                                                                                          } else {
                                                                                                            echo "0";
                                                                                                          } ?>
                                    </span>
                          ...
                          <div class="col-sm-6 text-right"> <a class="btn btn-primary cusbtn" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-calculator" aria-hidden="true"></i></a>
                            ...
                            <input type="button" id="add_payment2" class="btn btn-primary btn-large cusbtn" style="font-weight: bold;" onclick="quickorder()" name="add-payment" value="PEDIDO RAPIDO">
                            <input type="button" id="add_payment" class="btn btn-success btn-large cusbtn" style="font-weight: bold;" onclick="placeorder()" name="add-payment" value="REALIZAR PEDIDO">
        ...
        <div class="tab-pane fade" id="profile">
          <div class="row m-0" id="onprocesslist">
