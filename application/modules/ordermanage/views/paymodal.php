    ...
    <input name="<?php echo $this->security->get_csrf_token_name(); ?>" type="hidden" value="<?php echo $this->security->get_csrf_hash(); ?>" />
       <div class="modal-content">
            <div class="modal-header">
                ...
                <strong><?php echo "PAGAR ORDEN";?></strong>
            </div>
                    ...
                    <div class="row no-gutters">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group text-right mt-3">
							...
							?>
                            <button type="button" class="btn btn-success w-md m-b-5" id="pay_bill" onclick="submitmultiplepay(0)"><?php echo display('pay_print');?></button>
                            <!--<button type="button" class="btn btn-success w-md m-b-5" id="pay_bill" onclick="submitmultiplepay(1)"><?php echo "CONSUMO GERENCIAL";?></button>
                            -->
