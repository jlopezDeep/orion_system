            ...
            <h4 class="modal-title" id="myModalLabel">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    ?>
                            <li class="<?php if ($f == 1) {
                                            echo "active";
                                        } ?>"> <a href="#floor<?php echo $floor->tbfloorid; ?>" id="florlist<?php echo $f; ?>" role="tab" data-toggle="tab" class="home" onclick="showfloor(<?php echo $floor->tbfloorid; ?>)" style="font-size: 12px;"><?php echo $floor->floorName; ?></a> </li>
                    <?php }
                    } ?>
                </ul>
            </h4>
