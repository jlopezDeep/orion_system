        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart('setting/setting/create','class="form-inner"') ?>
                    ...
                    <div class="form-group row">
                        <label for="password_main" class="col-xs-3 col-form-label">Clave Principal</label>
                        <div class="col-xs-9">
                            <input name="password_main" type="text" class="form-control" id="password_main" placeholder="Clave Principal"  value="<?php echo $setting->password_main ?>">
                        </div>
                    </div>
