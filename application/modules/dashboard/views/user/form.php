    ...
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="form-group row">
                    <label for="pin" class="col-sm-3 col-form-label"><?php echo "PIN"; ?> *</label>
                    <div class="col-sm-9">
                        <input name="pin" class="form-control" type="password" placeholder="PIN" id="pin">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="checkbox checkbox-success">
                            <input type="checkbox" name="ismonitor" <?php if ($user->counter == 1) {
                                                                        echo "checked";
                                                                    } ?> value="1" id="ismonitor">
