        ...
        <div class="modal-content customer-list">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <?php endif; ?>
                    <!--<h3>Puede descargar un Ejemplo-<a class="btn btn-primary btn-md" href="<?php echo base_url() ?>itemmanage/item_food/downloadformat"><i class="fa fa-download" aria-hidden="true"></i>CSV</a></h3>
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-6">
                                ...
                                <?php foreach ($categories as $caregory) { ?>
                                    ...
                                    <?php if (!empty($caregory->sub)) {
                                        foreach ($caregory->sub as $subcat) { ?>
                                            <option value="<?php echo $subcat->CategoryID; ?>" <?php if ($productinfo->CategoryID == $subcat->CategoryID) {
                                                                                                    echo "selected";
                        ...
                        <div class="col-sm-8">
                            <select name="kitchen" class="form-control" required="">
                                ...
                                <?php foreach ($allkitchen as $kitchen) { ?>
                                    <option value="<?php echo $kitchen->kitchenid; ?>" class='bolden' <?php if ($productinfo->kitchenid == $kitchen->kitchenid) {
                                                                                                            echo "selected";
                    ...
                    <div class="form-group row">
                        <label for="itemnotes" class="col-sm-4 col-form-label">Description (CODE) </label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        <label for="itemnotes" class="col-sm-4 col-form-label">Color</label>
                        <div class="col-sm-8">
                            <input type="color" name="color" class="form-control" type="text" id="color" value="<?php echo (!empty($productinfo->color) ? $productinfo->color : null) ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" name="customqty" value="1" <?php if (!empty($productinfo)) if ($productinfo->is_customqty == 1) {
                                                                                        echo "checked";
                                                                                    } ?> id="customqty">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select name="status" class="form-control">
                                ...
                                <option value="0" <?php if ($productinfo->ProductsIsActive == 0) {
                                                        echo "Selected";
                                                    } ?>>Inactive</option>
                            </select>
                        </div>
                    ...
                    <script>
                        function enabledDisabledVariant() {
                            if (document.getElementById('create_variant').checked) {
                                document.getElementById('price_tax').disabled = false;
                                document.getElementById('price').disabled = false;
                                document.getElementById('bodegon').disabled = false;
                            } else {
                                document.getElementById('price_tax').disabled = true;
                                document.getElementById('price').disabled = true;
                                document.getElementById('bodegon').disabled = true;
                            }
                        }
                    </script>
                    <div class="form-group row">
                        <label for="create_variant" class="col-sm-5 col-form-label"><?php echo "Crear Variante Igual al Producto"; ?></label>
                        <div class="col-sm-2">
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" onclick="enabledDisabledVariant()" name="create_variant" value="1" <?php if (!empty($productinfo)) if ($productinfo->create_variant == 1) {
                                                                                            echo "checked";
                                                                                        } ?> id="create_variant">
                                <label for="create_variant"></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="price_tax" class="col-sm-5 col-form-label"><?php echo "Precio con Impuesto?"; ?></label>
                        <div class="col-sm-2">
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" disabled="true" name="price_tax" value="1" id="price_tax">
                                <label for="price_tax"></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="itemnotes" class="col-sm-5 col-form-label">Precio</label>
                        <div class="col-sm-2">
                            <input type="text" name="price" disabled="true" class="form-control" type="text" id="price" value="0">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="bodegon" class="col-sm-5 col-form-label"><?php echo "BODEGON"; ?></label>
                        <div class="col-sm-2">
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" disabled="true" name="bodegon" value="1" <?php if (!empty($productinfo)) if ($productinfo->bodegon == 1) {
                                                                                                    echo "checked";
                                                                                                } ?> id="bodegon">
                                <label for="bodegon"></label>
                            </div>
                        </div>
                    </div>
