        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="form-group row">
                        <label for="color" class="col-sm-4 col-form-label"><?php echo "color" ?> *</label>
                        <div class="col-sm-8">
                            <input name="color" class="form-control" type="color"  id="color" value="<?php echo (!empty($categoryinfo->color) ? $categoryinfo->color : "#37A000") ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="color" class="col-sm-4 col-form-label"><?php echo "Color en el grid" ?> *</label>
                        <div class="col-sm-8">
                            <input name="color_category_grid" class="form-control" type="color"  id="color_category_grid" value="<?php echo (!empty($categoryinfo->color_category_grid) ? $categoryinfo->color_category_grid : "#FCFBEA") ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="Parentcategory" class="form-control">
                                ...
                                ?>
                                    <option value="<?php echo $caregory->CategoryID; ?>" class='bolden' <?php if (!empty($categoryinfo)) {
                                                                                                            if ($categoryinfo->parentid == $caregory->CategoryID) {
                                                                                                                echo "selected";
                                                                                                            }
                                                                                                        } ?>><strong><?php echo $caregory->Name; ?></strong></option>
                                    <?php if (!empty($caregory->sub)) {
                                        foreach ($caregory->sub as $subcat) { ?>
                                            <option value="<?php echo $subcat->CategoryID; ?>" <?php if (!empty($categoryinfo)) {
                                                                                                    if ($categoryinfo->parentid == $subcat->CategoryID) {
                                                                                                        echo "selected";
                                                                                                    }
                ...
                <div class="col-lg-5">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <div class="checkbox checkbox-success">
                                <input type="checkbox" name="isoffer" value="1" <?php if (!empty($categoryinfo)) if ($categoryinfo->isoffer == 1) {
                                                                                    echo "checked";
                                                                                } ?> id="isoffer">
                    ...
                    <div id="offeractive" class="<?php if (!empty($categoryinfo)) {
                                                        if ($categoryinfo->isoffer == 1) {
                                                            echo "";
                                                        } else {
                                                            echo "showhide";
                                                        }
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select name="status" class="form-control">
                                ...
                                <option value="1" <?php if (!empty($categoryinfo)) {
                                                        if ($categoryinfo->CategoryIsActive == 1) {
                                                            echo "Selected";
                                                        }
                                                    } else {
                                                        echo "Selected";
                                                    } ?>>Active</option>
                                <option value="0" <?php if (!empty($categoryinfo)) {
                                                        if ($categoryinfo->CategoryIsActive == 0) {
                                                            echo "Selected";
                                                        }
                                                    } ?>>Inactive</option>
                            </select>
