                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label for="price" class="col-sm-4 col-form-label">Precio con Impuesto?</label>
                                    <div class="col-sm-8">
                                        <input name="price_type" class="form-control" type="checkbox" id="price_type" />
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <?php if (!empty($fooditemslist)) { ?>
                            ...
                            <?php foreach ($fooditemslist as $varient) { ?>
                                <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
                                    <td><?php echo $sl; ?></td>
                                    <td><?php echo $varient->descrip; ?></td>
                                    <td><?php echo $varient->Name; ?></td>
                                    <td><?php echo $varient->ProductName; ?></td>
                                    <td><?php echo $varient->variantName; ?></td>
                                    <td style="text-align: right;font-weight: bold;"><?php echo $varient->price; ?></td>
                                    <td style="text-align: right;font-weight: bold;"><?php echo round($varient->productvat, 2); ?></td>
                                    <td style="text-align: right;font-weight: bold;"><?php echo round((($varient->productvat / 100) + 1) * $varient->price, 2); ?></td>
                                    <td class="center">
