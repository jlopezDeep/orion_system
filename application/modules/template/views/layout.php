...
<body class="hold-transition sidebar-mini <?php if (($title == 'posinvoiceloading') || ($title == 'Counter Dashboard')) {
                                                echo "sidebar-collapse pace-done";
                                            } ?>">
    <!-- Site wrapper -->
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper <?php if ($title == 'posinvoiceloading') {
                                        echo "ml-0";
                                    } ?>">
                ...
                <section class="content-header">
                    ...
                    <div class="header-title">
                        <h1><?php if ($this->uri->segment(2) == "paymentmethod") {
                            ...
                            //Paymentmethod
                            ?>
                            <!--/--> <?php echo (!empty($titlename) ? ucwords($titlename) : null) ?>
                        </h1>
