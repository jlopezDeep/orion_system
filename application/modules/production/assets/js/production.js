...
function product_list(sl) {
    ...
    if (foodid == 0 || foodid == '') {
        ...
        swal("Receta", "Por favor selecione un producto para definir su composicion.!!!", "warning");
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            /*if (obj != null) {
                ...
                /*} else {
                    $('#product_id_' + sl).select2('destroy').val("").select2();
                    alert('Por favor compre este item para tener stock.!!!');
                    $('#unit-total_' + sl).val('');
                    return false;
                ...
                $('#product_id_' + sl).select2('destroy').val("").select2();
                //alert('Por favor compre este item para tener stock.!!!');
                swal("Receta", "Por favor compre este item para tener stock.!!!", "warning");
                $('#unit-total_' + sl).val('');
                return false;
            }*/
...
function calprice(element) {
    ...
    if (ingrden == 0 || ingrden == '') {
        ...
        swal("Receta", "Por favor selecione un item!!!", "warning");
...
$('input[type="checkbox"]').click(function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            if (ischeck == 1) {
                swal("Produccion Activa", "Activado modulo de produccion automatico", "success");
            } else {
                swal("Produccion Desactivada", "Desactivado entorno de produccion", "warning");
            }
        }
    });
});