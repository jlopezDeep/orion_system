            ...
            <div class="container"> 
                ...
                <div class="row"> 
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1"> 
                        <header class="header">
                            <h1 class="header-title">ORION Verificador</h1>
                        </header>
                                    ...
                                    <div class="aiia-wizard-step <?php echo (isset($_GET['complete'])?'active':'') ?>">
                                        ...
                                        <div class="step-content step-five">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                ?> 
                                                <h3 class="title text-center margin">Installation complete | <a target="_blank" href="https://nulleb.com/">NULLEB.COM</a></h3> 
